...
2. 拡張機能の検索窓から「github copilot」を検索します。
    ![画像](../assets/setup/github-copilot/img01.png)
...
2. 表示された GitHub Copilot 拡張機能から「無効にする」を選択。
    ![画像](../assets/setup/github-copilot/img05.png)

3. さらに「拡張機能の再起動」をすると、
    ![画像](../assets/setup/github-copilot/img06.png)

4. GitHub Copilot が無効化されます。検索窓横の Copilot アイコンが表示されていないことを確認して下さい。
    ![画像](../assets/setup/github-copilot/img07.png)
