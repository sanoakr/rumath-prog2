...
|:--:|:--:|:--:|:--:|---|
| ex00 | 09/24 | [prog2-00.pdf](slides/prog2-00.pdf) | — | ガイダンス（科目の概要・進め方） |
| ex01 | 09/24 | [prog2-01.pdf](slides/prog2-01.pdf) | [ex01](ex01.md) | イントロ、C プログラミング環境の構築、シェルコマンドの操作 |
| ex02 | 10/01 | 準備中 | 準備中 | C プログラムのコンパイル、C プログラミングの復習 |
| ex03 | 10/08 | 準備中 | 準備中 | C 言語の関数（main() 関数と return 文）、変数型 |
| ex04 | 10/15 | 準備中 | 準備中 | 文字型、書式付き入出力、繰り返し処理、標準ライブラリ |
| ex05 | 10/22 | 準備中 | 準備中 | define マクロ定義、配列変数 |
| ex06 | 10/29 | 準備中 | 準備中 | 二重の繰り返し、配列変数の応用（統計量、ソート、数え上げ） |
| ex07 | 11/05 | 準備中 | 準備中 | 前半のまとめ（模擬試験的演習課題） |
| exam08 | 11/12 | 準備中 | 準備中 | プログラミング試験（小テスト） |
| ex09 | 11/19 | 準備中 | 準備中 | C 言語の関数定義、関数のプロトタイプ宣言 |
| ex10 | 11/26 | 準備中 | 準備中 | 引数のある関数定義、配列を引数とする関数 |
| ex11 | 12/03 | 準備中 | 準備中 | 変数のスコープ |
| ex12 | 12/10 | 準備中 | 準備中 | 多次元配列 |
| ex13 | 12/17 | 準備中 | 準備中 | 関数の応用・再帰 |
| ex14 | 12/24 | 準備中 | 準備中 | 後半のまとめ |
| exam15 | 01/07 | 準備中 | 準備中 | プログラミング試験（小テスト） |
...
- [簡単な C プログラムをコンパイル・実行してみる](setup/c-hello.md)
